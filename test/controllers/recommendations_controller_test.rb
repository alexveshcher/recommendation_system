...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { importance: @recommendation.importance, user_id: @recommendation.user_id, video_id: @recommendation.video_id } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { importance: @recommendation.importance, user_id: @recommendation.user_id, video_id: @recommendation.video_id } }
